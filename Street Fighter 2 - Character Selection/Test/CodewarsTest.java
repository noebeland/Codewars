...
public class CodewarsTest {
    ...
    public void shouldWorkWithNoMoves() {
        ...
        assertEquals(solution, Codewars.streetFighterSelection(fighters, new int[]{0,0}, new String[]{}));
    }
    ...
    public void shouldWorkWithFewMoves(){
        ...
        assertEquals(solution, Codewars.streetFighterSelection(fighters, new int[] {0,0}, moves));
    }
